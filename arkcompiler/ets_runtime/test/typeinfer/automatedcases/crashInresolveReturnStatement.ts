...
AssertType(WITDialogs.createCopyOfWorkItem(), "void");
AssertType(WITDialogs.createCopyOfWorkItem, "() => void");
    }
}
...
AssertType(createWorkItemDialog(CreateCopyOfWorkItemDialog), "void");
AssertType(createWorkItemDialog, "<P0>(P0) => void");
AssertType(CreateCopyOfWorkItemDialog, "typeof CreateCopyOfWorkItemDialog");
    }
}
