...
const K = {
AssertType(K, "{ a: string; b: string; }");
...
AssertType(K.a, "string");
AssertType(aVal, "number");
AssertType(K.b, "string");
AssertType(bVal, "number");
AssertType((() => {	return { [K.a]: 1, [K.b]: 1 };}), "() => { [string]: number; }");
AssertType(() => {	return { [K.a]: 1, [K.b]: 1 };}, "() => { [string]: number; }");
AssertType((() => {	return { [K.a]: 1, [K.b]: 1 };})(), "{ [string]: number; }");

AssertType({ [K.a]: 1, [K.b]: 1 }, "{ [string]: number; }");
