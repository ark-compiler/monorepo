...
const obj = {
AssertType(obj, "{ [Symbol.species]: ArrayConstructor; }");
AssertType({    [Symbol.species]: Array}, "{ [Symbol.species]: ArrayConstructor; }");

    [Symbol.species]: Array
AssertType([Symbol.species], "ArrayConstructor");
