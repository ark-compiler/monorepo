...
AssertType(fromAny, "unique symbol");
...
const o4 = {
AssertType(o4, "{ method1(typeof s): typeof s; method2(I["readonlyType"]): I["readonlyType"]; }");
...
const ce0 = class {
AssertType(ce0, "typeof ce0");
AssertType(class {    method1(p: typeof s): typeof s {        return p;    }    method2(p: I["readonlyType"]): I["readonlyType"] {        return p;    }}, "typeof ce0");
