...
AssertType(cafoo, "ObjectContaining<{ a: number; foo: number; }>");
AssertType(a, "number");
AssertType(foo, "number");

declare let cfoo: ObjectContaining<Foo>;
AssertType(cfoo, "ObjectContaining<Foo>");

cfoo = cafoo;
AssertType(cfoo = cafoo, "ObjectContaining<{ a: number; foo: number; }>");
AssertType(cfoo, "ObjectContaining<Foo>");
AssertType(cafoo, "ObjectContaining<{ a: number; foo: number; }>");

cafoo = cfoo;
AssertType(cafoo = cfoo, "ObjectContaining<Foo>");
AssertType(cafoo, "ObjectContaining<{ a: number; foo: number; }>");
AssertType(cfoo, "ObjectContaining<Foo>");
