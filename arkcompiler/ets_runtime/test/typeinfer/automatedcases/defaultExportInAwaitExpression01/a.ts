...
AssertType(x, "Promise<unknown>");
AssertType(new Promise( ( resolve, reject ) => { resolve( {} ); } ), "Promise<unknown>");
AssertType(Promise, "PromiseConstructor");
AssertType(( resolve, reject ) => { resolve( {} ); }, "((unknown) => void, (?any) => void) => void");
AssertType(resolve, "(unknown) => void");
AssertType(reject, "(?any) => void");
AssertType(resolve( {} ), "void");
AssertType(resolve, "(unknown) => void");
AssertType({}, "{}");
