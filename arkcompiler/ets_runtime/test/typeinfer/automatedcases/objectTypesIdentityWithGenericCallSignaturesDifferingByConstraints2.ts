...
let a: { foo<T extends U, U extends Array<string>>(x: T, y: U): string 
AssertType(a, "{ foo<T extends U, U extends string[]>(T, U): string; }");

AssertType(foo, "<T extends U, U extends string[]>(T, U) => string");
...
let b = { foo<T extends U, U extends RegExp>(x: T, y: U) { 
AssertType(b, "{ foo<T extends U, U extends RegExp>(T, U): string; }");
AssertType({ foo<T extends U, U extends RegExp>(x: T, y: U) { return ''; } }, "{ foo<T extends U, U extends RegExp>(T, U): string; }");
AssertType(foo, "<T extends U, U extends RegExp>(T, U) => string");
AssertType(x, "T");
AssertType(y, "U");
AssertType('', "string");
return ''; } };
