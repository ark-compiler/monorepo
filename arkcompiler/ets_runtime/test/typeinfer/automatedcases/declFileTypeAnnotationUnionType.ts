...
AssertType(k, "union");
AssertType(m, "any");
AssertType(new c() || new m.c(), "union");
AssertType(new c(), "c");
...
AssertType(x, "union");
AssertType(m, "any");
AssertType(new g<string>() ||  new m.g<number>() || (() => new c()), "union");
AssertType(new g<string>() ||  new m.g<number>(), "union");
...
let y = new g<string>() || new m.g<number>() || (() => new c());
AssertType(y, "union");
AssertType(new g<string>() || new m.g<number>() || (() => new c()), "union");
AssertType(new g<string>() || new m.g<number>(), "union");
AssertType(new g<string>(), "g<string>");
