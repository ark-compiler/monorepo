...
`hello ${t1 + t2 ** t2 + t1 }`;
AssertType(`hello ${t1 + t2 ** t2 + t1 }`, "string");
...
AssertType(`hello ${1 + typeof (t1 ** t2 ** t1) }`, "string");
...
`hello ${t1 ** t2}${t1 ** t2}`;
AssertType(`hello ${t1 ** t2}${t1 ** t2}`, "string");
AssertType(t1 ** t2, "number");
AssertType(t1, "number");
AssertType(t2, "number");
AssertType(t1 ** t2, "number");
...
AssertType(`hello ${t1 ** t2 ** t1}${t1 ** t2 ** t1}`, "string");
AssertType(t1 ** t2 ** t1, "number");
AssertType(t1, "number");
AssertType(t2 ** t1, "number");
AssertType(t2, "number");
...
AssertType(`hello ${t1 + t2 ** t2 + t1}${t1 + t2 ** t2 + t1}`, "string");
AssertType(t1 + t2 ** t2 + t1, "number");
AssertType(t1 + t2 ** t2, "number");
AssertType(t1, "number");
AssertType(t2 ** t2, "number");
...
AssertType(`hello ${typeof (t1 ** t2 ** t1) }${typeof (t1 ** t2 ** t1) }`, "string");
AssertType(typeof (t1 ** t2 ** t1), "union");
AssertType((t1 ** t2 ** t1), "number");
AssertType(t1 ** t2 ** t1, "number");
AssertType(t1, "number");
...
AssertType(`hello ${t1 ** t2} hello world ${t1 ** t2}`, "string");
AssertType(t1 ** t2, "number");
AssertType(t1, "number");
AssertType(t2, "number");
AssertType(t1 ** t2, "number");
...
AssertType(`hello ${t1 ** t2 ** t1} hello world ${t1 ** t2 ** t1}`, "string");
AssertType(t1 ** t2 ** t1, "number");
AssertType(t1, "number");
AssertType(t2 ** t1, "number");
AssertType(t2, "number");
...
AssertType(`hello ${t1 + t2 ** t2 + t1} hello world ${t1 + t2 ** t2 + t1}`, "string");
AssertType(t1 + t2 ** t2 + t1, "number");
AssertType(t1 + t2 ** t2, "number");
AssertType(t1, "number");
AssertType(t2 ** t2, "number");
...
AssertType(`hello ${typeof (t1 ** t2 ** t1) } hello world ${typeof (t1 ** t2 ** t1) }`, "string");
AssertType(typeof (t1 ** t2 ** t1), "union");
AssertType((t1 ** t2 ** t1), "number");
AssertType(t1 ** t2 ** t1, "number");
AssertType(t1, "number");
