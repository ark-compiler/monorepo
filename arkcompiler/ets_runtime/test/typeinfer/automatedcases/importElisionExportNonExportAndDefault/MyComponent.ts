...
AssertType(MyFunction, "(MyFunction) => void");
AssertType(({ msg }: MyFunction) => console.log(`Got message "${msg}"`), "(MyFunction) => void");
AssertType(msg, "string");
AssertType(console.log(`Got message "${msg}"`), "void");
AssertType(console.log, "(...any[]) => void");
AssertType(`Got message "${msg}"`, "string");
AssertType(msg, "string");
