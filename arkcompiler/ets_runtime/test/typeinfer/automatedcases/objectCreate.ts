...
let n = Object.create(null);             // object
AssertType(n, "any");
AssertType(Object.create(null), "any");
AssertType(Object.create, "{ (union): any; (union, PropertyDescriptorMap & ThisType<any>): any; }");
AssertType(null, "null");
...
let u = Object.create(union);            // object | {a: number, b: string 
AssertType(u, "any");
