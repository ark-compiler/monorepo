...
#include "containerslistforeach_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainerslistForEachFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        callInfo1->SetCallArg(1, list.GetTaggedValue());
        ContainersList::ForEach(callInfo1);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainerslistForEachFuzzTest(data, size);
    return 0;
}