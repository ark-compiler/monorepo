...
#include "containerslistgetindexof_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainerslistGetIndexOfFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersList::GetIndexOf(callInfo1);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainerslistGetIndexOfFuzzTest(data, size);
    return 0;
}