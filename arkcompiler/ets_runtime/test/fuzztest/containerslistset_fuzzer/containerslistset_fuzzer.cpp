...
#include "containerslistset_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainerslistSetFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainerslistSetFuzzTest(data, size);
    return 0;
}