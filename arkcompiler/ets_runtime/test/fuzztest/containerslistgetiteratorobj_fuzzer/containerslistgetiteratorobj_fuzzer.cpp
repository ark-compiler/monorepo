...
#include "containerslistgetiteratorobj_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainerslistGetIteratorObjFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersList::GetIteratorObj(callInfo1);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainerslistGetIteratorObjFuzzTest(data, size);
    return 0;
}