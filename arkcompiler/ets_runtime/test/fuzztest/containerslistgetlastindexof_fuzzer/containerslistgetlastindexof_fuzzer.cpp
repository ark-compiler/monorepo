...
#include "containerslistgetlastindexof_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainerslistGetLastIndexOfFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersList::GetLastIndexOf(callInfo);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainerslistGetLastIndexOfFuzzTest(data, size);
    return 0;
}