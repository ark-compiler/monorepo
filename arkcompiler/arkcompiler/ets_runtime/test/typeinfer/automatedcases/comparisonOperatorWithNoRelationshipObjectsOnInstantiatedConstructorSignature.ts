...
let b1: { new (): string };
AssertType(b1, "new () => string");

let a2: { new <T>(x: T): T };
AssertType(a2, "new <T>(T) => T");
AssertType(x, "T");

let b2: { new (x: string): number };
AssertType(b2, "new (string) => number");
AssertType(x, "string");

let a3: { new <T>(x?: T): T };
AssertType(a3, "new <T>(?T) => T");
AssertType(x, "T");

let b3: { new (x?: string): number };
AssertType(b3, "new (?string) => number");
AssertType(x, "string");
...
let b4: { new (...x: string[]): number };
AssertType(b4, "new (...string[]) => number");
AssertType(x, "string[]");

let a5: { new <T>(x: T, y: T): T };
AssertType(a5, "new <T>(T, T) => T");
AssertType(x, "T");
AssertType(y, "T");

let b5: { new (x: string, y: number): string };
AssertType(b5, "new (string, number) => string");
AssertType(x, "string");
AssertType(y, "number");

let a6: { new <T, U extends T>(x: T, y: U): T };
AssertType(a6, "new <T, U extends T>(T, U) => T");
AssertType(x, "T");
AssertType(y, "U");

let b6: { new (x: Base, y: C): Base };
AssertType(b6, "new (Base, C) => Base");
AssertType(x, "Base");
AssertType(y, "C");
