...
obj.foo(1, 2, "abc");
AssertType(obj.foo(1, 2, "abc"), "X");
AssertType(obj.foo, "(number, number, ...string[]) => X");
AssertType(1, "int");
AssertType(2, "int");
AssertType("abc", "string");

obj.foo(1, 2, ...a);
AssertType(obj.foo(1, 2, ...a), "X");
AssertType(obj.foo, "(number, number, ...string[]) => X");
AssertType(1, "int");
AssertType(2, "int");
AssertType(...a, "string");
...
obj.foo(1, 2, ...a, "abc");
AssertType(obj.foo(1, 2, ...a, "abc"), "X");
AssertType(obj.foo, "(number, number, ...string[]) => X");
AssertType(1, "int");
AssertType(2, "int");
AssertType(...a, "string");
...
AssertType(obj.foo(1, 2, ...a).foo(1, 2, "abc"), "X");
AssertType(obj.foo(1, 2, ...a).foo, "(number, number, ...string[]) => X");
AssertType(1, "int");
AssertType(2, "int");
AssertType("abc", "string");

obj.foo(1, 2, ...a).foo(1, 2, ...a);
AssertType(obj.foo(1, 2, ...a).foo(1, 2, ...a), "X");
AssertType(obj.foo(1, 2, ...a).foo, "(number, number, ...string[]) => X");
AssertType(1, "int");
AssertType(2, "int");
AssertType(...a, "string");
...
AssertType(obj.foo(1, 2, ...a).foo(1, 2, ...a, "abc"), "X");
AssertType(obj.foo(1, 2, ...a).foo, "(number, number, ...string[]) => X");
AssertType(1, "int");
AssertType(2, "int");
AssertType(...a, "string");
...
xa[1].foo(1, 2, "abc");
AssertType(xa[1].foo(1, 2, "abc"), "X");
AssertType(xa[1].foo, "(number, number, ...string[]) => X");
AssertType(1, "int");
AssertType(2, "int");
AssertType("abc", "string");

xa[1].foo(1, 2, ...a);
AssertType(xa[1].foo(1, 2, ...a), "X");
AssertType(xa[1].foo, "(number, number, ...string[]) => X");
AssertType(1, "int");
AssertType(2, "int");
AssertType(...a, "string");
...
xa[1].foo(1, 2, ...a, "abc");
AssertType(xa[1].foo(1, 2, ...a, "abc"), "X");
AssertType(xa[1].foo, "(number, number, ...string[]) => X");
AssertType(1, "int");
AssertType(2, "int");
AssertType(...a, "string");
