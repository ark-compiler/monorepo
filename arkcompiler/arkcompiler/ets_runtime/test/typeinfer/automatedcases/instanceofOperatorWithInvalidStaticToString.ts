...
AssertType(staticToString instanceof StaticToString, "boolean");
AssertType(staticToString, "StaticToString");
AssertType(StaticToString, "typeof StaticToString");
...
AssertType(staticToNumber instanceof StaticToNumber, "boolean");
AssertType(staticToNumber, "StaticToNumber");
AssertType(StaticToNumber, "typeof StaticToNumber");
...
AssertType(normal instanceof NormalToString, "boolean");
AssertType(normal, "NormalToString");
AssertType(NormalToString, "typeof NormalToString");
