...
let a = "foo" === "bar" as string;
AssertType(a, "boolean");
AssertType("foo" === "bar" as string, "boolean");
AssertType("foo", "string");
AssertType("bar" as string, "string");
AssertType("bar", "string");

let b = "foo" !== ("bar" as string);
...
AssertType("foo" == (<any>"bar"), "boolean");
AssertType("foo", "string");
AssertType((<any>"bar"), "any");
AssertType(<any>"bar", "any");
AssertType("bar", "string");
