...
AssertType(ColumnSelectView1, "new <S extends Schema>() => Table<UnrollOnHover<S>>");
AssertType(ColumnSelectViewImp, "typeof ColumnSelectViewImp");

const ColumnSelectView2: new <S extends Schema>() => Table<UnrollOnHover<S>> = Table;
AssertType(ColumnSelectView2, "new <S extends Schema>() => Table<UnrollOnHover<S>>");
AssertType(Table, "typeof Table");
