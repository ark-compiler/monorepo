...
`${t1 + t2 ** t2 + t1 } world`;
AssertType(`${t1 + t2 ** t2 + t1 } world`, "string");
...
AssertType(`${1 + typeof (t1 ** t2 ** t1) } world`, "string");
...
`${t1 ** t2}${t1 ** t2} world`;
AssertType(`${t1 ** t2}${t1 ** t2} world`, "string");
AssertType(t1 ** t2, "number");
AssertType(t1, "number");
AssertType(t2, "number");
AssertType(t1 ** t2, "number");
...
AssertType(`${t1 ** t2 ** t1}${t1 ** t2 ** t1} world`, "string");
AssertType(t1 ** t2 ** t1, "number");
AssertType(t1, "number");
AssertType(t2 ** t1, "number");
AssertType(t2, "number");
...
AssertType(`${t1 + t2 ** t2 + t1}${t1 + t2 ** t2 + t1} world`, "string");
AssertType(t1 + t2 ** t2 + t1, "number");
AssertType(t1 + t2 ** t2, "number");
AssertType(t1, "number");
AssertType(t2 ** t2, "number");
...
AssertType(`${typeof (t1 ** t2 ** t1) }${typeof (t1 ** t2 ** t1) } world`, "string");
AssertType(typeof (t1 ** t2 ** t1), "union");
AssertType((t1 ** t2 ** t1), "number");
AssertType(t1 ** t2 ** t1, "number");
AssertType(t1, "number");
