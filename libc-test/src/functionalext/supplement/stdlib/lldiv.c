 ...
 * @tc.level     : Level 0
 */
void lldiv_0100(void)
{
    lldiv_t ret = lldiv(TEST_LDIV_P_SEVENT, TEST_LDIV_P_FOUR);
    EXPECT_EQ("lldiv_0100", ret.quot, 1);
    EXPECT_EQ("lldiv_0100", ret.rem, TEST_LDIV_P_THREE);

    ret = lldiv(TEST_LDIV_P_SEVENT, TEST_LDIV_N_FOUR);
    EXPECT_EQ("lldiv_0100", ret.quot, ERREXPECT);
    EXPECT_EQ("lldiv_0100", ret.rem, TEST_LDIV_P_THREE);

    ret = lldiv(TEST_LDIV_N_SEVENT, TEST_LDIV_P_FOUR);
    EXPECT_EQ("lldiv_0100", ret.quot, ERREXPECT);
    EXPECT_EQ("lldiv_0100", ret.rem, TEST_LDIV_N_THREE);
