...
namespace OHOS {
    namespace SmartPerf {
        double ParseClickResponseTrace::ParseResponseTrace(std::string fileNamePath)
        {
            int conversion = 1000;
        ...
        double ParseClickResponseTrace::GetLineTime()
        {
            std::string line;
        ...
        double  ParseClickResponseTrace::GetTime(std::string startTime, std::string endTime)
        {
