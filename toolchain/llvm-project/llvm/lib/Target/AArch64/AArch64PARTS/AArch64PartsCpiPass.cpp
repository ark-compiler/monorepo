...
**/
inline bool AArch64PartsCpiPass::handleInstruction(MachineBasicBlock &MBB, MachineBasicBlock::instr_iterator &MIi) {
...
void AArch64PartsCpiPass::lowerPARTSPACIA(MachineBasicBlock &MBB, MachineInstr &MI) {
    lowerPARTSIntrinsicCommon(MBB, MI, TII->get(AArch64::PACIA));
    ++StatPacia;
}

inline void AArch64PartsCpiPass::lowerPARTSAUTIA(MachineBasicBlock &MBB, MachineInstr &MI) {
    lowerPARTSIntrinsicCommon(MBB, MI, TII->get(AArch64::AUTIA));
    ++StatAutia;
}

void AArch64PartsCpiPass::lowerPARTSAUTCALL(MachineBasicBlock &MBB, MachineInstr &MI) {
    LLVM_DEBUG(MBB.dump());
    llvm_unreachable("Unexpected PARTSAUTCALL found!!!!");
}

void AArch64PartsCpiPass::lowerPARTSIntrinsicCommon(MachineBasicBlock &MBB, MachineInstr &MI,
