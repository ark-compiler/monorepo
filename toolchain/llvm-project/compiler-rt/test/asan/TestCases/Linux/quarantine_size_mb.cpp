...
// HUAWEI: Sometimes measured RSS on device is 19Mb and test fails with 20Mb limit
// RUN: %env_asan_opts=hard_rss_limit_mb=10                         not  %run %t          2>&1 | FileCheck %s  --check-prefix=RSS_LIMIT
