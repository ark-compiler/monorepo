...
cases(fn(opts => { }));
AssertType(cases(fn(opts => { })), "void");
AssertType(cases, "(Tester) => void");
AssertType(fn(opts => { }), "Mock<[opts: any]>");
AssertType(fn, "<Y extends any[]>(?union) => Mock<Y>");
AssertType(opts => { }, "(any) => void");
AssertType(opts, "any");
