...
AssertType(class extends base {        mixinProperty: string;    }, "{ new (...any[]): (Anonymous class); prototype: MyMixin<any>.(Anonymous class); } & T");
AssertType(base, "MyBaseClass<any>");
    return class extends base {

        mixinProperty: string;
AssertType(mixinProperty, "string");
    }
}
