...
// the type of a letiable or parameter is narrowed by any type guard in the left operand when false, 
// provided the right operand contains no assignments to the letiable or parameter.
...
AssertType(typeof x !== "string" || ((x = 10) || x), "union");
AssertType(typeof x !== "string", "boolean");
AssertType(typeof x, "union");
AssertType(x, "union");
AssertType("string", "string");
...
AssertType(typeof x !== "string" || ((x = "hello") || x), "union");
AssertType(typeof x !== "string", "boolean");
AssertType(typeof x, "union");
AssertType(x, "union");
AssertType("string", "string");
...
AssertType(typeof x === "string" // string | number | boolean        || ((b = x) || (typeof x === "number"  // number | boolean        || x)), "union");
AssertType(typeof x === "string", "boolean");
AssertType(typeof x, "union");
AssertType(x, "union");
AssertType("string", "string");
...
AssertType(((b = x) || (typeof x === "number"  // number | boolean        || x)), "union");
AssertType((b = x) || (typeof x === "number"  // number | boolean        || x), "union");
...
AssertType(typeof x === "string"        || ((z = x) // number | boolean        || (typeof x === "number"        // change value of x        ? ((x = 10) && x.toString()) // number | boolean | string        // do not change value        : ((y = x) && x.toString()))), "union");
AssertType(typeof x === "string", "boolean");
AssertType(typeof x, "union");
AssertType(x, "union");
AssertType("string", "string");
    return typeof x === "string"
        ...
        || ((z = x) // number | boolean
AssertType(((z = x) // number | boolean        || (typeof x === "number"        // change value of x        ? ((x = 10) && x.toString()) // number | boolean | string        // do not change value        : ((y = x) && x.toString()))), "union");
AssertType((z = x) // number | boolean        || (typeof x === "number"        // change value of x        ? ((x = 10) && x.toString()) // number | boolean | string        // do not change value        : ((y = x) && x.toString())), "union");
...
AssertType(x, "union");
        ...
        || (typeof x === "number"
AssertType((typeof x === "number"        // change value of x        ? ((x = 10) && x.toString()) // number | boolean | string        // do not change value        : ((y = x) && x.toString())), "string");
AssertType(typeof x === "number"        // change value of x        ? ((x = 10) && x.toString()) // number | boolean | string        // do not change value        : ((y = x) && x.toString()), "string");
AssertType(typeof x === "number", "boolean");
AssertType(typeof x, "union");
AssertType(x, "union");
