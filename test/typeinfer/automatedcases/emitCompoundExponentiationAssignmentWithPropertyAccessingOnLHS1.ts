...
AssertType({ prop: 2 }, "{ prop: number; }");
AssertType(prop, "number");
AssertType(2, "int");
    return { prop: 2 };
}
foo().prop **= 2;
AssertType(foo().prop **= 2, "number");
AssertType(foo().prop, "number");
AssertType(2, "int");

let result0 = foo().prop **= 2;
AssertType(result0, "number");
AssertType(foo().prop **= 2, "number");
AssertType(foo().prop, "number");
AssertType(2, "int");

foo().prop **= foo().prop **= 2;
AssertType(foo().prop **= foo().prop **= 2, "number");
AssertType(foo().prop, "number");
AssertType(foo().prop **= 2, "number");
AssertType(foo().prop, "number");
AssertType(2, "int");
