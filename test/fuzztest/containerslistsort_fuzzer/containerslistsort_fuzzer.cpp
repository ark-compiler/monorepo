...
#include "containerslistsort_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainerslistSortFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainerslistSortFuzzTest(data, size);
    return 0;
}