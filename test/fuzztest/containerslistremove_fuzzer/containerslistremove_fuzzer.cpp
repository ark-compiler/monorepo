...
#include "containerslistremove_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainerslistRemoveFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersList::Remove(callInfo1);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainerslistRemoveFuzzTest(data, size);
    return 0;
}