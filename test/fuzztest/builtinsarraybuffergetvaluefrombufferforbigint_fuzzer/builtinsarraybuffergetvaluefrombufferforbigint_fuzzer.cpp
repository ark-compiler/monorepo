...
#include "builtinsarraybuffergetvaluefrombufferforbigint_fuzzer.h"
...
namespace OHOS {
    void BuiltinsArrayBufferGetValueFromBufferForBigIntFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::BuiltinsArrayBufferGetValueFromBufferForBigIntFuzzTest(data, size);
    return 0;
}