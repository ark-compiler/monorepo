...
protected:
    ...
    inline void lowerPartsIntrinsic(MachineFunction &MF, MachineBasicBlock &MBB, MachineInstr &MI,
        const MCInstrDesc &InstrDesc);
    inline void insertMovInstr(MachineBasicBlock &MBB, MachineInstr *MI, unsigned dstReg, unsigned srcReg);
    inline void replacePartsIntrinsic(MachineFunction &MF, MachineBasicBlock &MBB, MachineInstr &MI,
        const MCInstrDesc &InstrDesc);
...
inline void AArch64PartsPassCommon::lowerPartsIntrinsic(MachineFunction &MF, MachineBasicBlock &MBB, MachineInstr &MI,
    const MCInstrDesc &InstrDesc) {
...
inline void AArch64PartsPassCommon::replacePartsIntrinsic(MachineFunction &MF, MachineBasicBlock &MBB, MachineInstr &MI,
        const MCInstrDesc &InstrDesc) {
    lowerPartsIntrinsic(MF, MBB, MI, InstrDesc);
    MI.removeFromParent();
}

inline void AArch64PartsPassCommon::insertPACInstr(MachineBasicBlock &MBB, MachineInstr *MI, unsigned dstReg,
    unsigned modReg, const MCInstrDesc &InstrDesc) {
    if (MI != nullptr) {
        BuildMI(MBB, MI, MI->getDebugLoc(), InstrDesc, dstReg)
        .addReg(dstReg)
        .addReg(modReg, RegState::InternalRead);
    } else {
...
inline void AArch64PartsPassCommon::insertMovInstr(MachineBasicBlock &MBB, MachineInstr *MI, unsigned dstReg,
    unsigned srcReg) {
...
inline void AArch64PartsPassCommon::replacePartsXPACDIntrinsic(MachineFunction &MF, MachineBasicBlock &MBB,
    MachineInstr &MI) {
    const unsigned dst = MI.getOperand(0).getReg();
